...
rsync -avm --include='*/' --include='*freetype*' --include='*harfbuzz*' --include='**/freetype2/**' --include='**/harfbuzz/**' --exclude='*' install/* dep-av/windows
...
rsync -avm --include='*/' --include='*freetype*' --include='*harfbuzz*' --include='**/freetype2/**' --include='**/harfbuzz/**' --exclude='*' install/* dep-av/windows-ltl
for A in x64 x86; do
...
rsync -avm --include='*/' --include='*freetype*' --include='*harfbuzz*' --include='**/freetype2/**' --include='**/harfbuzz/**' --exclude='*' install/* dep-av/android
...
rsync -avm --include='*/' --include='*freetype*' --include='*harfbuzz*' --include='**/freetype2/**' --include='**/harfbuzz/**' --exclude='*' install/* dep-av/macOS
...
rsync -avm --include='*/' --include='*freetype*' --include='*harfbuzz*' --include='**/freetype2/**' --include='**/harfbuzz/**' --exclude='*' install/arm64/* dep-av/iOS
...
rsync -avm --include='*/' --include='*freetype*' --include='*harfbuzz*' --include='**/freetype2/**' --include='**/harfbuzz/**' --exclude='*' install/arm64/* dep-av/tvOS
...
rsync -avm --include='*/' --include='*freetype*' --include='*harfbuzz*' --include='**/freetype2/**' --include='**/harfbuzz/**' --exclude='*' install/arm64/* dep-av/visionOS
