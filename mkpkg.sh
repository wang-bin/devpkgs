...
rsync -avm --include='*/' --include='**lz4**' --include='**/z*' --include='**/mfx/**' --include='*mfx.lib' --include='**/vpl/**' --include='*vpl.lib' --include='*shaderc*' --include='**/shaderc/**' --include='*freetype*' --include='*fribidi*' --include='*harfbuzz*' --include='*ass.*' --include='**/ass/**' --include='**/freetype2/**' --include='**/fribidi/**' --include='**/harfbuzz/**' --exclude='*' install/* dep-av/windows
...
rsync -avm --include='*/' --include='**lz4**' --include='**/mfx/**' --include='*/libmfx.a' --include='**/vpl/**' --include='*/libvpl.a' --include='*/libcppcompat.a' --include='*shaderc*' --include='**/shaderc/**' --include='*wolfssl*' --include='**/wolfssl/**' --exclude='*' install/* dep-av/linux
